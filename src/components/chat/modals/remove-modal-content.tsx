...
export interface RemoveModalContentProps {
  channelName: string;
  onRemove: () => void;
  onCancel: () => void;
}

export default function RemoveModalContent({
  channelName,
  onCancel,
  onRemove,
}: RemoveModalContentProps) {
  return (
    <>
      <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
        <div className="sm:flex sm:items-start">
          ...
          <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
            <h1 className="text-2xl">Delete Channel</h1>

            <div className="mt-2">
              <p className="text-sm text-gray-500">
                Are you sure you want to remove channel{" "}
                <strong className="text-black">`{channelName}`</strong> ? All of your data will be
